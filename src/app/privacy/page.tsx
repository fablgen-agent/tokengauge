...
export default function PrivacyPage() {
  return <div className="subpage"><SiteHeader /><main className="legal-page"><span className="eyebrow">PRIVACY</span><h1>Small data footprint.</h1><p className="updated">Effective 15 August 2026</p>
    ...
    <h2>Control and retention</h2><p>Disconnecting removes the local ChatGPT session. Payment and entitlement records may be retained for accounting, fraud prevention, and legal obligations. You may request access or deletion through the public project support channel once published.</p>
