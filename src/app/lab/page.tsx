...
import { RecordedMeasurementAudit } from "@/components/recorded-measurement-audit";
  ...
  return (
    <div className="subpage">
      ...
      <main>
        ...
        <RecordedMeasurementAudit />
        {sources.length ? (
          <section id="live-lab" className="lab-shell section-pad">
        ...
        ) : <section id="live-lab" className="gate-card"><h2>Connect a model source to run a paired test.</h2><p>{supportedTips.length} controlled request-setting recipes are available. Use ChatGPT for the starter lab, or connect any supported provider API key from Settings with Pro.</p><ChatGPTPanel /><Link className="button button-dark" href="/settings">Open provider settings</Link></section>}
      </main>
    </div>
  );
}
