...
export default function TermsPage() {
  return <div className="subpage"><SiteHeader /><main className="legal-page"><span className="eyebrow">TERMS</span><h1>Plain-language terms.</h1><p className="updated">Effective 15 August 2026</p>
    ...
    <h2>Fixed-scope implementation work</h2><p>Custom implementation begins only after a written scope identifies the authorized codebase, deliverables, acceptance checks, delivery target, price, and payment timing. The advertised £75 attribution setup covers only the boundaries listed on its service page and includes one revision. Expanded work requires a separate written agreement. Do not send credentials, private source, customer data, or payment details through the initial enquiry channel.</p>
