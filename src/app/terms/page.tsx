...
export default function TermsPage() {
  return <div className="subpage"><SiteHeader /><main className="legal-page"><span className="eyebrow">TERMS</span><h1>Plain-language terms.</h1><p className="updated">Effective 15 August 2026</p>
    ...
    <h2>Founding access</h2><p>The displayed £9 price is a one-time payment for access to the current Pro library, the A/B lab, and future additions while the service remains available. It is not a subscription and includes no OpenAI API credit or ChatGPT allowance.</p>
    ...
    <h2>Refunds</h2><p>You may request a refund within 14 days of purchase. This policy does not limit statutory consumer rights. A refund deactivates Pro access.</p>
