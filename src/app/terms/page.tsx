...
export default function TermsPage() {
  return <div className="subpage"><SiteHeader /><main className="legal-page"><span className="eyebrow">TERMS</span><h1>Plain-language terms.</h1><p className="updated">Effective 15 August 2026</p>
    ...
    <h2>Pro access</h2><p>The displayed £9 price is a one-time payment for access to the current Pro library and future catalogue additions while the service remains available. It is not a subscription and includes no OpenAI API credit or ChatGPT allowance. Supported A/B recipes remain free after connection.</p>
