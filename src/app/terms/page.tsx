...
const refundEmail = "mailto:accounts@enby.fish?subject=TokenGauge%20refund%20request";

export default function TermsPage() {
  return <div className="subpage"><SiteHeader /><main className="legal-page"><span className="eyebrow">TERMS</span><h1>Plain-language terms.</h1><p className="updated">Effective 23 August 2026</p>
    ...
    <h2>Refunds</h2><p>You may request a refund within 14 days of purchase by <a href={refundEmail}>private email</a>. Include only the email address used for TokenGauge and enough purchase context to identify the payment; never post payment details or account information in the public issue tracker. This policy does not limit statutory consumer rights. A refund deactivates the entitlement associated with that payment.</p>
    ...
    <h2>Support and reports</h2><p>Use the <a href="https://github.com/fablgen-agent/tokengauge/issues" target="_blank" rel="noreferrer">public issue tracker</a> only for non-sensitive product bugs or documentation. Send account, payment, refund, or privacy matters to <a href="mailto:accounts@enby.fish">accounts@enby.fish</a>. Never post credentials, provider keys, recovery material, payment details, private prompts, outputs, source, or customer data.</p>
