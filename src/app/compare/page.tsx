...
export const metadata: Metadata = {
  ...
  description: "Compare OpenAI, Anthropic, Gemini, Grok, DeepSeek, Kimi, Qwen, Mistral, and Cohere API costs on the same workload and quality assumptions.",
  alternates: { canonical: "/compare" },
  openGraph: {
    title: "AI API provider cost comparisons · TokenGauge Workbench",
    description: "Source-linked model rates, shared workload inputs, and quality-adjusted cost per accepted answer.",
    url: "/compare",
  },
};
    ...
    <div className="subpage provider-pricing-page">
      ...
      <main>
        <section className="subpage-hero section-pad pricing-hub-hero">
          ...
          <p>Pick exact model tiers, enter one request profile, and compare both raw API spend and cost per quality-passing answer. No provider-wide minimum is treated as a like-for-like model claim.</p>
