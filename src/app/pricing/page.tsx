    ...
    <div className="subpage provider-pricing-page">
      ...
      <main>
        <section className="subpage-hero section-pad pricing-hub-hero">
          ...
          <div className="hero-actions"><Link className="button button-lime" href="/audit" data-funnel-event="cta_audit">Audit an existing bill</Link><Link className="text-link" href="#calculator">Model a token workload <span aria-hidden="true">→</span></Link><Link className="text-link" href="/pricing/media">Price image + video units <span aria-hidden="true">→</span></Link><Link className="text-link" href="/pricing/changes">Review price changes <span aria-hidden="true">→</span></Link></div>
        </section>
