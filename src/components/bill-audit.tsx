  ...
  return (
    <div className="calculator-shell bill-audit-shell">
      ...
      <div className="calculator-result" aria-live="polite">
        ...
        <div className="calculator-next-step"><span className="eyebrow">NEXT STEP</span><strong>Test the biggest controllable bucket without relaxing quality.</strong><p>Use the evidence library to choose a bounded intervention, then compare identical tasks in the lab before calling the modeled overhead a saving.</p><div><Link className="button button-lime" href="/lab" data-funnel-event="cta_lab">Run a controlled test</Link><Link className="text-link" href="/library">Find a method <span aria-hidden="true">→</span></Link><Link className="text-link" href="/#pricing" data-funnel-event="cta_pricing">Unlock the complete workbench <span aria-hidden="true">→</span></Link></div></div>
      </div>
    </div>
  );
}
