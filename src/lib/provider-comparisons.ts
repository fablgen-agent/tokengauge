...
export const providerComparisons: readonly ProviderComparison[] = [
  {
    ...
    description: "Compare current GPT and Claude API rate cards on the same task volume, token counts, retry overhead, quality, observed p95 latency, and required OpenAI-client checks.",
  ...
  },
  {
    ...
    description: "Compare Google Gemini and xAI Grok API costs with model, context, region, retries, quality, observed p95 latency, and required client checks kept visible.",
  ...
  },
  {
    ...
    description: "Compare DeepSeek and Moonshot Kimi API spend without hiding effective dates, cache modes, retries, observed latency, required client checks, or batch-only discounts.",
  ...
  },
  {
    ...
    description: "Compare Moonshot Kimi and Alibaba Qwen API costs while preserving region, input band, cache, retry, latency, client-check, and execution-mode assumptions.",
